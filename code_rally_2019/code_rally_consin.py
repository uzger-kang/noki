...
# 卷积层,48个卷积核
model.add(Convolution2D(nb_filter=48, nb_row=1, nb_col=2,
                        activation='relu',
...
model.fit(BS_data, XY_data, nb_epoch=90, batch_size=32,
          shuffle=True, verbose=2, validation_split=0.2,
          callbacks=[tbCallBack])
model.save('C:\\my_ml\\code_rally_2019\\model\\my_model_con_sin.h5')
